        ...
        <div className="w-full max-w-md relative">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-yellow-300/20">
            <div className="text-center mb-6">
              ...
              <p className="text-yellow-100 text-sm">Sign in to access your betting insights</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-yellow-100">Remember me</span>
                </label>
            ...
            <div className="mt-6 mb-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-transparent text-yellow-200">Or continue with</span>
                </div>
              </div>
            </div>
